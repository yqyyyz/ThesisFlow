...
export const DEMO_STAGES: DemoStage[] = [
  ...
  },
  {
    ...
    actions: [
      { label: "进入起草模式", kind: "setMode", mode: "drafting" },
      {
        ...
        kind: "copy",
        copyText:
          "我要写一篇《AI 长上下文管理的工程化措施综述与展望》，请帮我设计大纲：需要覆盖上下文窗口扩展、GraphRAG、混合检索与引用校验四条主线，并突出工程化措施的比较框架。",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      "讲解提案卡机制：AI 永不直接修改编辑器，输出包含完整引用标记的提案卡供审核",
      "讲解三色引用徽标：蓝 = 引用正常、黄 = 弱支持、红 = 无效引用",
  ...
  },
  {
    ...
    steps: [
      ...
      "勾选问题卡 →「AI 一键修改所选问题」→ 逐条 Diff 审核采纳",
